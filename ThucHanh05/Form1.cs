...

{
    public partial class Form1 : Form
    {
        ...
        {
            customers.Add(new Customer(1, "Nguyễn Văn A", "0000000", "Ha noi"));
            customers.Add(new Customer(2, "Tran Thi B", "1111111", "Ha Nam"));
            services.Add(new Service(1, "Bay", 200000));
            services.Add(new Service(2, "Nhay", 150000));
            services.Add(new Service(3, "Hat", 100000));
        }
